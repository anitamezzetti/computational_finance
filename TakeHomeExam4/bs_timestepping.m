function [U,FD_grid,time_steps] = bs_timestepping(sigma,r,forcing,bc_right,init_cond,S_max,NS,T,Nt,theta)
% bs_timestepping
%
% Inputs:
%   sigma       : volatility (real number)
%   r           : risk-free return (real number)
%   forcing     : @-function describing the right-hand-side of the equation, forcing = @(R,t) ...
